...
CONTAINER_NAME = "nginx-to-mongodb"

# generate a name without dashes
CONTAINER_NAME_CLEAR = "nginx_to_mongodb"
...
setup(
    ...
    description='A syslog server that stores nginx logs into MongoDB',
    ...
    author_email='hadi.razzaghi87@gmail.com',
